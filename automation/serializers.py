...
class AutomationSerializer(serializers.Serializer):
    ...
    links = serializers.ListSerializer(child=serializers.CharField(), required=False)
    target_cities = serializers.ListSerializer(child=serializers.CharField(), required=False)
