            ...
            if request.method != "POST":
                ...
                def generate_and_save_article():
                    ...
                    try:
                        ...
                        return Response({"message": "Article did not save successfully"},
                ...
                if page_exists is False:
                    ...
                    if page.exists() == False:
                        ...
                        if 'article_sub_verb' in locals():
                            return Response({'message': 'Article using verb and subject saved Successfully'},
        ...
        if 'session_id' and 'username' in request.session:
            if request.method != "POST":
                ...
                if not form.is_valid():
                    ...
                    return Response({'error': 'Please fix the errors below', 'data': response_data},
                                    status=status.HTTP_400_BAD_REQUEST)
                headers = {
                ...
                if response.status_code == 403:
                    ...
                    return Response({'error': 'Error code 403 Forbidden: Website does not allow to verify the article.',
