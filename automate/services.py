...
def post_list(user_id):
    ...
    "Facebook-Technology","Coca-Cola-Beverages","Disney-Leisure","Samsung-Technology","Louis Vuitton-Luxury",
    "McDonald's-Restaurants","Toyota-Automotive","Intel-Technology","NIKE-Apparel","AT&T-Telecom",
        "Cisco-Technology","Oracle-Technology","Verizon-Telecom","Visa-Financial Services","Walmart-Retail",
        "GE-Diversified","Budweiser-Alcohol","SAP-Technology","Mercedes-Benz-Automotive","IBM-Technology","Marlboro-Tobacco",
        "Netflix-Technology","BMW-Automotive","American Express-Financial Services","Honda-Automotive",
        "LOreal-Consumer Packaged Goods","Gucci-Luxury","Hermes-Luxury","Nescafe-Beverages","Home Depot-Retail",
        "Accenture-Business Services","Pepsi-Beverages","Starbucks-Restaurants","Mastercard-Financial Services",
        "Frito-Lay-Consummer Packaged Goods","IKEA-Retail","Zara-Retail","Gillette-Consumer Packaged Goods","HSBC-Financial Services",
        "Audi-Automotive","J.P.Morgan-Financial Services","Deloitte-Business Services","Sony-Technology","UPS-Transportation",
        "Bank of America-Financial Services","Chase-Financial Services","Adidas-Apparel","Channel-Luxuey","Siemens-Diversified",
        "Nestle-Consumer Packaged Goods","CVS-Retail","Cartier-Luxury","Porsche-Automotive","ESPN-Media",
        "Citi-Financial Services","Wells Fargo -Financial Servies","Adobe-Technology","Pampers-Consumer Packaged Goods","Corona-Alchol",
        ...
        "UBS-Financial Services","KFC-Restaurants","Burger King-Restaurants","EY-Business Services","FedEx-Transportation","Volkswagen-Automotive"]
    Designed_for=["Twitter-uxlivinglab","Linkdin-uxliving","Facebook-Customer stories",
        "Instagram-Livinglabstories","Youtube-Dowell True Moments UX Living Lab","Tiktok","Vimeo-(Brand)",
