    ...
    return (
        <nav className="bg-customBlue text-white dark:bg-gray-900  w-full z-20 sticky top-0 border-b border-gray-200 dark:border-gray-600">
            <div className=" flex flex-wrap items-center justify-between p-4 lg:px-20">
                ...
                <div className="flex md:order-2 gap-4 md:pr-4">
                    ...
                    <button data-tooltip-target="user-tooltip1" data-tooltip-placement="left" type="button" className="flex mr-3 text-sm bg-white rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark-focus-ring-gray-600 relative " id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown1" data-dropdown-placement="right">
                                <span className="sr-only">Open user menu</span>
                                <FaUser className="w-8 h-8 rounded-full text-customBlue p-1" />
                            ...
                            <div id="user-tooltip1" role="tooltip" className="absolute z-50 invisible inline-block px-3 py-2 text-tooltipsm font-medium text-customBlue bg-white rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                User profile
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg text-white md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <li>
                            <a href="https://100093.pythonanywhere.com/" target="_blank" className="block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover-bg-gray-700 dark:hover-text-white md:dark:hover-bg-transparent dark-border-gray-700">Client Admin</a>
                        </li>
                        ...
                        <li>
                            ...
                            <div id="settingsDropdown" className="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <Link to="/settings/hastagsandmentions" className="block px-4 py-2 hover:bg-gray-100 dark:hover-bg-gray-600 dark:hover-text-white">Hashtags & Mentions</Link>
                                    </li>
                                    <li>
                                        <Link to="/settings/categoriesandtopic" className="block px-4 py-2 hover:bg-gray-100 dark:hover-bg-gray-600 dark:hover-text-white">Categories & Topic</Link>
                                    </li>
                        ...
                        <li className="md:hidden">
                            ...
                            <button data-tooltip-target="user-tooltip" data-tooltip-placement="right" type="button" className="flex mr-3 text-sm bg-white rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark-focus-ring-gray-600 relative " id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="right">
                                <span className="sr-only">Open user menu</span>
                                <FaUser className="w-8 h-8 rounded-full text-customBlue p-1" />
                                <svg className="w-2.5 h-2.5 ml-2.5 absolute -right-4 top-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
