export const TargetForListOptions = () => {
  return (
    <>
      ...
      <option value='American Express-Financial Services'>
        American Express-Financial Services
      </option>
      <option value='Honda-Automotive'>Honda-Automotive</option>
      <option value='LOreal-Consumer Packaged Goods'>
        LOreal-Consumer Packaged Goods
      </option>
      ...
      <option value='Accenture-Business Services'>
      ...
      <option value='Mastercard-Financial Services'>
        Mastercard-Financial Services
      </option>
      <option value='Frito-Lay-Consummer Packaged Goods'>
        Frito-Lay-Consummer Packaged Goods
      </option>
      <option value='IKEA-Retail'>IKEA-Retail</option>
      <option value='Zara-Retail'>Zara-Retail</option>
      <option value='Gillette-Consumer Packaged Goods'>
      ...
      <option value='J.P.Morgan-Financial Services'>
        J.P.Morgan-Financial Services
      </option>
      <option value='Deloitte-Business Services'>
      ...
      <option value='Bank of America-Financial Services'>
      ...
      <option value='Nestle-Consumer Packaged Goods'>
        Nestle-Consumer Packaged Goods
      </option>
      ...
      <option value='Wells Fargo -Financial Servies'>
        Wells Fargo -Financial Servies
      </option>
      <option value='Adobe-Technology'>Adobe-Technology</option>
      <option value='Pampers-Consumer Packaged Goods'>
        Pampers-Consumer Packaged Goods
      </option>
      ...
      <option value='PayPal-Financial Services'>
      ...
      <option value='Colgate-Consumer Packaged Goods'>
        Colgate-Consumer Packaged Goods
      </option>
      <option value='Fox-Media'>Fox-Media</option>
      <option value="Lowe's-Retail">{"Lowe's"} Retail</option>
      <option value='Lancome-Consumer Packaged Goods'>
        Lancome-Consumer Packaged Goods
      </option>
      <option value='H&M-Retail'>H&M-Retail</option>
      <option value='Lexus-Automotive'>Lexus-Automotive</option>
      <option value='Santander-Financial Services'>
      ...
      <option value='Danone-Consumer Packaged Goods'>
        Danone-Consumer Packaged Goods
      </option>
      <option value='Heinenken-Alcohol'>Heineken-Alcohol</option>
      <option value='Uniqlo-Apparel'>Uniqlo-Apparel</option>
      <option value='Goldman Sachs-Financial Services'>
      ...
      <option value='Allianz-Financial Services'>
        Allianz-Financial Services
      </option>
      <option value='Dell-Technology'>Dell-Technology</option>
      <option value='Caterpillar-Heavy Equipment'>
      ...
      <option value='John Deere-Heavy Equipment'>
...
export const QualitativeCategorizationList = () => {
  return (
    <>
