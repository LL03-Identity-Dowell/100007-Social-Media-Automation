  ...
  return (
      ...
      <Dialog.Trigger asChild>
          ...
          <Dialog.Portal>
              ...
              <Dialog.Content
                  className='data-[state=open]:animate-contentShow fixed top-[50%] left-[50%]  translate-x-[-50%] translate-y-[-50%] rounded-3xl bg-[#e6e8e9] p-10 space-y-8 focus:outline-none shadow-md w-7/12 bg-[#edeeeefb]'>
