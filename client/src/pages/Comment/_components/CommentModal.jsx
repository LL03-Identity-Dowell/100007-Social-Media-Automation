  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Trigger asChild>
        <button
          type='button'
          className='px-4 py-1 text-white bg-gray-500 rounded-md cursor-pointer'>
          Create comment
        </button>
      </Dialog.Trigger>
      <Dialog.Portal>
        ...
        <Dialog.Content className='data-[state=open]:animate-contentShow fixed top-[50%] left-[50%]  translate-x-[-50%] translate-y-[-50%] rounded-3xl bg-[#e6e8e9] p-4 md:p-11 space-y-10 focus:outline-none shadow-md w-11/12 md:w-[650px] bg-[#edeeeefb]'>
          ...
          <form
            ...
            <textarea
              ...
              rows='4'
              name='comment'
              className='w-full text-xl text-gray-700 placeholder:text-xl placeholder:opacity-50'></textarea>
