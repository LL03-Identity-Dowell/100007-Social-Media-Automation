...
import {FaMailBulk, FaMapMarkedAlt, FaUser, FaUserCheck,} from "react-icons/fa";
    ...
    return (
        <UserWrapper>
            <div className='flex flex-col items-center justify-center w-full h-full'>
                ...
                <div
                    className='flex flex-wrap items-center justify-center gap-4 mt-6 md:flex-row md:mt-10 md:gap-8 xl:gap-12 '>
                    <Link
                        to='/client-profile'
