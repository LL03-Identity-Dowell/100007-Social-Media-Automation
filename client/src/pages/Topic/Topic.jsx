    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center items-center pb-10">
                ...
                >
                    <div
                        className="flex justify-center md:items-center gap-2 md:gap-8 flex-col md:flex-row mr-6 md:mr-0 w-full ">
                ...
                <span className="w-[65px] border-r border-gray-300 py-4">
                  Choose
                    ...
                    <div
                        className="flex justify-end md:items-center gap-2 md:gap-8 flex-col md:flex-row mr-6 md:mr-0 w-full ">
                        <div className="w-full md:w-[300px] ">
