                ...
                <div className="flex justify-center items-center flex-col h-full w-full">
                    ...
                    <form className="w-full px-6">
                        <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 w-full">
                            <div className="text-center w-full">
                                ...
                                <div className="mt-4 w-full border flex">
                                    ...
                                    <input type="text" id="hashtags" placeholder="Enter Hashtags.."
                        ...
                        <div className="flex justify-center items-center mt-6 md:mt-16">
                            <button
                                className="bg-customTextBlue px-4 py-2 text-white rounded-md flex items-center gap-3">Save <FaCheck/>
                            </button>
