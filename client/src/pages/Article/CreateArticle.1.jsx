...
export const CreateArticle = ({show}) => {
    ...
    return (
        <div
            className="flex flex-col justify-center items-center article-container relative h-[100vh] max-w-7xl mx-auto lg:h-auto overflow-y-hidden lg:overflow-y-visible ">
            {loading && <Loading/>}
