...
var v = {
    list: /* @__PURE__ */ new Map(), emitQueue: /* @__PURE__ */ new Map(), on(t2, e2) {
...
var T = (e2) => {
    ...
    return import_react.default.createElement("svg", {
        ...
        width: "100%",
        height: "100%",
        fill: "colored" === n2 ? "currentColor" : `var(--toastify-icon-color-${o2})`, ...s2
    });
};
var E = {
    info: function (e2) {
...
function C(t2) {
    const [, o2] = (0, import_react.useReducer)((t3) => t3 + 1, 0), [l2, c] = (0, import_react.useState)([]),
        g2 = (0, import_react.useRef)(null), h2 = (0, import_react.useRef)(/* @__PURE__ */ new Map()).current,
        T2 = (t3) => -1 !== l2.indexOf(t3), C2 = (0, import_react.useRef)({
            toastKey: 1,
            displayedToast: 0,
            count: 0,
            queue: [],
    ...
    function L2(t3, n2) {
        ...
        const M2 = {
            ...b3,
            style: b3.toastStyle,
            key: C2.toastKey++, ...Object.fromEntries(Object.entries(i2).filter((t4) => {
                let [e2, n3] = t4;
                return null != n3;
            })),
            toastId: l3,
            ...
            closeToast: L3,
            isIn: false,
            className: m(i2.className || b3.toastClassName),
            bodyClassName: m(i2.bodyClassName || b3.bodyClassName),
            progressClassName: m(i2.progressClassName || b3.progressClassName),
            autoClose: !i2.isLoading && (R2 = i2.autoClose, w2 = b3.autoClose, false === R2 || u(R2) && R2 > 0 ? R2 : w2),
            deleteToast() {
        ...
        let x2 = t3;
        (0, import_react.isValidElement)(t3) && !d(t3.type) ? x2 = (0, import_react.cloneElement)(t3, {
            closeToast: L3,
            toastProps: M2,
            data: T3
        }) : p(t3) && (x2 = t3({
            ...
            toastProps: M2,
            data: T3
        })), b3.limit && b3.limit > 0 && C2.count > b3.limit && N2 ? C2.queue.push({
            toastContent: x2,
            toastProps: M2,
            staleId: r3
        }) : u(s2) ? setTimeout(() => {
...
function _(t2) {
    const [o2, a2] = (0, import_react.useState)(false), [r3, l2] = (0, import_react.useState)(false),
        c = (0, import_react.useRef)(null), u2 = (0, import_react.useRef)({
            start: 0,
            x: 0,
            y: 0,
            delta: 0,
            ...
            boundingRect: null,
            didMove: false
        }).current, d2 = (0, import_react.useRef)(t2), {
            autoClose: m2,
            pauseOnHover: f2,
            closeToast: g2,
            onClick: h2,
...
function L(e2) {
    ...
    return import_react.default.createElement("button", {
        className: `Toastify__close-button Toastify__close-button--${o2}`, type: "button", onClick: (t2) => {
...
function O(e2) {
    ...
    const h2 = r3 || u2 && 0 === d2,
        y2 = {...l2, animationDuration: `${n2}ms`, animationPlayState: o2 ? "running" : "paused", opacity: h2 ? 0 : 1};
    u2 && (y2.transform = `scaleX(${d2})`);
    const v2 = clsx_m_default("Toastify__progress-bar", u2 ? "Toastify__progress-bar--controlled" : "Toastify__progress-bar--animated", `Toastify__progress-bar-theme--${g2}`, `Toastify__progress-bar--${a2}`, {"Toastify__progress-bar--rtl": m2}),
        T2 = p(i2) ? i2({rtl: m2, type: a2, defaultClassName: v2}) : clsx_m_default(v2, i2);
...
var N = (n2) => {
    const {isRunning: o2, preventExitTransition: s2, toastRef: r3, eventHandlers: i2} = _(n2), {
            closeButton: l2,
            children: u2,
            autoClose: d2,
            onClick: m2,
        ...
        F2 = clsx_m_default("Toastify__toast", `Toastify__toast-theme--${z2}`, `Toastify__toast--${f2}`, {"Toastify__toast--rtl": x2}, {"Toastify__toast--close-on-click": A2}),
        H2 = p(T2) ? T2({rtl: x2, position: v2, type: f2, defaultClassName: F2}) : clsx_m_default(F2, T2),
        S2 = !!w2 || !d2, q2 = {closeToast: h2, type: f2, theme: z2};
    let Q2 = null;
    return false === l2 || (Q2 = p(l2) ? l2(q2) : (0, import_react.isValidElement)(l2) ? (0, import_react.cloneElement)(l2, q2) : L(q2)), import_react.default.createElement(y2, {
        isIn: P2,
        done: k2,
        position: v2,
        ...
        ...P2 && {role: R2},
        className: p(C2) ? C2({type: f2}) : clsx_m_default("Toastify__toast-body", C2),
        style: b2
    }, null != D2 && import_react.default.createElement("div", {className: clsx_m_default("Toastify__toast-icon", {"Toastify--animate-icon Toastify__zoom-enter": !B2})}, D2), import_react.default.createElement("div", null, u2)), Q2, import_react.default.createElement(O, {
        ...M2 && !S2 ? {key: `pb-${M2}`} : {},
        rtl: x2,
        theme: z2,
        delay: d2,
...
var k = (0, import_react.forwardRef)((e2, n2) => {
    const {getToastToRender: o2, containerRef: a2, isToastActive: r3} = C(e2), {
        className: i2,
        style: l2,
        rtl: u2,
        containerId: d2
    ...
    return (0, import_react.useEffect)(() => {
        ...
        return import_react.default.createElement("div", {
            ...
            return import_react.default.createElement(N, {
                ...a3,
                isIn: r3(a3.toastId),
                style: {...a3.style, "--nth": o4 + 1, "--len": n3.length},
                key: `toast-${a3.key}`
            }, s2);
        }));
    }));
...
Q.loading = (t2, e2) => H(t2, S("default", {
    ...
    const i2 = {isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null},
        l2 = (t3, e3, s3) => {
            if (null == e3)
    ...
    void 0 === e2 && (e2 = {}), setTimeout(() => {
        ...
        if (n2) {
            const {props: o2, content: s2} = n2,
                a2 = {delay: 100, ...o2, ...e2, toastId: e2.toastId || t2, updateId: z()};
