...
console.log(userStatus);
  ...
  var decodedValue = doc.documentElement.textContent;

  console.log(decodedValue);
  if (decodedValue.includes("twitter")) {
    const twiter = document.querySelector(".twitter");
    twiter.classList.add("fa-twitter");
  }
  if (decodedValue.includes("facebook")) {
    const twiter = document.querySelector(".facebook");
    twiter.classList.add("fa-facebook");
  }
  if (decodedValue.includes("instagram")) {
    const twiter = document.querySelector(".instagram");
    twiter.classList.add("fa-instagram-square");
  }
  if (decodedValue.includes("linkedin")) {
    const twiter = document.querySelector(".linkedin");
    twiter.classList.add("fa-linkedin");
  }
  if (decodedValue.includes("youtube")) {
    const twiter = document.querySelector(".youtube");
    twiter.classList.add("fa-youtube");
  }
  if (decodedValue.includes("pinterest")) {
    const twiter = document.querySelector(".pinterest");
    twiter.classList.add("fa-pinterest");
  }
  ...
  const showPopup = {
    ...
    appendBtnLinkAndDone() {
      document.querySelector(".button-container-activate").style.display =
        "none";
      var buttonContainerDone = document.querySelector(
        ".button-container-done"
      );
      var buttonContainerLink = document.querySelector(
